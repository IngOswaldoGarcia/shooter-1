...
public class EnemyActions : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 targetPositionXZ = new Vector3(GameController.instance.player.transform.position.x, transform.position.y, GameController.instance.player.transform.position.z);
